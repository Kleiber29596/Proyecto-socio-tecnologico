...
if (!empty($page)) {
	...
	$data = array(
		...
		'inicioIngr' => array('model' => 'RecepcionMedicamentosModel', 'view' => 'inicioingreso', 'controller' => 'RecepcionMedicamentosController'),
		'listarRecepcionMedicamentos' => array('model' => 'RecepcionMedicamentosModel', 'view' => 'listarRecepcionMedicamentos', 'controller' => 'RecepcionMedicamentosController'),
		'listarActualizacionRecepcionMedicamento' => array('model' => 'RecepcionMedicamentosModel', 'view' => 'listarActualizacionRecepcionMedicamento', 'controller' => 'RecepcionMedicamentosController'),
		'modificarRecepcionMedicamento' => array('model' => 'RecepcionMedicamentosModel', 'view' => 'modificarRecepcionMedicamento', 'controller' => 'RecepcionMedicamentosController'),
		'registrarRecepcionMedicamento' => array('model' => 'RecepcionMedicamentosModel', 'view' => 'registrarRecepcionMedicamento', 'controller' => 'RecepcionMedicamentosController'),
		/* Modulo Banco de Medicamentos*/
		'inicioBancoMedicamentos' => array('model' => 'BancoMedicamentosModel', 'view' => 'inicioBancoMedicamentos', 'controller' => 'BancoMedicamentosController'),
		'listarBancoMedicamentos' => array('model' => 'BancoMedicamentosModel', 'view' => 'listarBancoMedicamentos', 'controller' => 'BancoMedicamentosController'),
		/* Modulo Entrega de Medicamentos*/
		'inicioEntregaMedicamentos' => array('model' => 'EntregaMedicamentosModel', 'view' => 'inicioEntregaMedicamentos', 'controller' => 'EntregaMedicamentosController'),
		'listarEntregaMedicamentos' => array('model' => 'EntregaMedicamentosModel', 'view' => 'listarEntregaMedicamentos', 'controller' => 'EntregaMedicamentosController'),
		'consultarPersona' => array('model' => 'PersonasModel', 'view' => 'consultarPersona', 'controller' => 'PersonasController'),
		'registrarEntregaMedicamento' => array('model' => 'EntregaMedicamentosModel', 'view' => 'registrarEntregaMedicamento', 'controller' => 'EntregaMedicamentosController'),
