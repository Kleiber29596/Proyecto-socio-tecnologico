...
--
-- Servidor: localhost
-- Tiempo de generación: 04-09-2024 a las 17:16:52
...
--
-- Estructura de tabla para la tabla `banco_medicamentos`
--

CREATE TABLE `banco_medicamentos` (
  `id_banco_medicamento` int(11) NOT NULL,
...
INSERT INTO `citas` (`id_cita`, `id_paciente`, `id_especialidad`, `id_doctor`, `observacion`, `estatus`, `fecha_cita`, `fecha_registro`) VALUES
(1, 1, 1, 2, '...', 0, '2024-06-03', '2024-06-11'),
(2, 1, 1, 2, 'ingreso', 1, '2025-06-25', '2024-06-25');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `codigo_categoria_medicamento`
--

CREATE TABLE `codigo_categoria_medicamento` (
...
--
-- Volcado de datos para la tabla `codigo_categoria_medicamento`
--

INSERT INTO `codigo_categoria_medicamento` (`id_codigo_categoria`, `codigo`, `categoria`) VALUES
(1, 1, 'Anestésicos'),
(2, 2, 'Analgésicos_Antipiréticos_AINES'),
(3, 3, 'Antialérgicos'),
(4, 4, 'Antiepilécticos'),
(5, 5, 'Antihelmínticos_Antiparasitarios'),
(6, 6, 'Antibióticos_Antifúngicos_Antivirales'),
(7, 7, 'Antiamebianos_Antileishmaniasis'),
(8, 8, 'Antimaláricos'),
(9, 9, 'Inmunosupresores_Antineoplásicos');
...
INSERT INTO `consultas` (`id_consulta`, `id_tipo_consulta`, `id_persona`, `diagnostico`, `edad`, `id_recipe`, `id_usuario`, `fecha_registro`, `fecha_actualizacion`) VALUES
(1, 1, 9, 'Tos seca.', 24, 1, 11, '2024-08-27', NULL),
(2, 1, 10, '...', 60, 2, 34, '2024-08-29', NULL),
(3, 1, 11, 'Presenta sintomas de tos seca', 42, 3, 28, '2024-08-31', NULL),
(4, 1, 10, '...', 60, 4, 28, '2024-08-31', NULL),
(5, 1, 9, '1', 24, 5, 28, '2024-08-31', NULL);
...
INSERT INTO `doctor` (`id_doctor`, `id_especialidad`, `id_persona`, `dia_inicio`, `dia_fin`, `hora_inicio`, `hora_fin`) VALUES
(1, 1, 1, 'Lunes', 'Viernes', '00:00:00', '00:00:00'),
(2, 1, 3, 'Lunes', 'Viernes', '06:00:00', '12:00:00');
...
CREATE TABLE `entrega_medicamentos` (
  `id_entrega_medicamento` int(11) NOT NULL,
  `id_presentacion_medicamento` int(11) NOT NULL,
  `cantidad_entrega` int(50) NOT NULL,
...
INSERT INTO `entrega_medicamentos` (`id_entrega_medicamento`, `id_presentacion_medicamento`, `cantidad_entrega`, `parentesco`, `rango_edad`, `descripcion`, `fecha_entrega`, `id_persona`) VALUES
(1, 6, 500, 'ninguno', '20 - 40', 'Entrega de 500 unidades de ibuprofeno en pastillas', '2024-01-21', 1),
(2, 6, 200, 'Hermano', '20 - 40', 'Entrega de 200 unidades de Ibuprofeno en pastillas', '2024-01-21', 2),
(3, 4, 50, 'ninguno', '40 - 20', 'donacion de paracetamol', '2024-01-20', 1);
...
INSERT INTO `personas` (`id_persona`, `n_documento`, `tipo_documento`, `nombres`, `apellidos`, `fecha_nacimiento`, `sexo`, `telefono`, `id_estado`, `id_municipio`, `id_parroquia`, `correo`, `fecha_registro`) VALUES
(2, '29596688', 'V', 'Kleiber ', 'Aranguren Pacheco', '2003-11-08', 'Masculino', '04161454551', 24, 462, 1119, 'kleiber8113@gmail.com', '2024-06-08'),
(9, '27333664', 'V', 'Jesus', 'Aranguren', '1999-12-11', 'Masculino', '04161454556', 24, 462, 1119, 'jesusaranguren675@gmail.com', '2024-08-25'),
(10, '29596688', 'V', 'Federico Antonio', 'Aranguren Pacheco', '1964-03-21', 'Masculino', '04161454551', 24, 462, 1119, 'federico21364@gmail.com', '2024-08-29'),
(11, '16203350', 'V', 'Marli', 'Pacheco', '1982-07-27', 'Masculino', '04161454551', 24, 462, 1119, 'kleiber8113@gmail.com', '2024-08-30');
...
--
-- Estructura de tabla para la tabla `recepcion_medicamentos`
--

CREATE TABLE `recepcion_medicamentos` (
  `id_recepcion_medicamento` int(11) NOT NULL,
...
--
-- Volcado de datos para la tabla `recepcion_medicamentos`
--

INSERT INTO `recepcion_medicamentos` (`id_recepcion_medicamento`, `medicamento`, `cantidad`, `procedencia`, `fecha_vencimiento`, `descripcion`, `fecha_registro`) VALUES
(1, 1, 100, 'x', '2024-07-12', 'ingreso', '2023-12-16');
...
(1, 11, 'No ingerir alimentos lacteos durante la administración.', '2024-08-27'),
(2, 34, '...', '2024-08-29'),
(3, 28, '...', '2024-08-31'),
(4, 28, '...', '2024-08-31'),
(5, 28, '...', '2024-08-31');
...
INSERT INTO `recipes_medicamentos` (`id_recipe_medicamento`, `id_presentacion_medicamento`, `id_recipe`, `dosis`, `unidad_medida`, `frecuencia`, `duracion`, `fecha_registro`, `fecha_actualizacion`) VALUES
(1, 3, 1, 1, 'unidad', '8 horas', '2 dias', '2024-08-27', NULL),
(2, 2, 1, 1, 'unidad', '8 horas', '2 dias', '2024-08-27', NULL),
(3, 1, 2, 1, 'unidad', '8 horas', '24 horas', '2024-08-29', NULL),
(4, 2, 2, 1, 'unidad', '8 horas', '24 horas', '2024-08-29', NULL),
(5, 3, 2, 1, 'unidad', '8 horas', '24 horas', '2024-08-29', NULL),
(6, 1, 4, 1, 'unidad', '8 horas', '24 horas', '2024-08-31', NULL),
(7, 2, 5, 1, 'unidad', '8 dias', '2 dias', '2024-08-31', NULL),
(8, 3, 5, 1, 'unidad', '8 dias', '2 dias', '2024-08-31', NULL);
...
INSERT INTO `roles` (`id`, `rol`, `estatus`, `fecha`) VALUES
(1, 'TECNOLOGIA', 1, '2023-11-06'),
(2, 'ADMINISTRADOR', 1, '2023-11-06'),
(3, 'USUARIO ', 1, '2023-11-06'),
(5, 'PRUEBA', 1, '2024-06-11'),
(6, 'PRUEBA ROL asdsa', 1, '2024-06-11'),
(7, 'PRUEBA PRUEBA', 1, '2024-06-11'),
(8, 'ALMACENISTA', 1, '2024-08-20'),
(9, 'ALMACENISTA', 1, '2024-08-20'),
(10, 'GERENTE', 1, '2024-08-20'),
(11, 'COORDINADOR', 1, '2024-08-20');
...
INSERT INTO `tbl_temporal_medicamentos` (`id_temporal_medicamento`, `id_presentacion_medicamento`, `dosis`, `unidad_medida`, `frecuencia`, `duracion`, `id_usuario`) VALUES
(132, 1, 1, 'unidad', '8 horas', '', NULL),
(133, 2, 1, 'unidad', '8 horas', '24 horas', NULL);
...
INSERT INTO `usuario` (`id`, `cedula`, `usuario`, `nombre`, `apellido`, `correo`, `foto`, `fecha`, `contrasena`, `rol`, `estatus`) VALUES
(28, 27333664, 'jesus979', 'Jesus', 'Aranguren', 'jesusaranguren675@gmail.com', 'user.jpg', '2024-06-20', '123456', 2, 1);
...
--
-- Indices de la tabla `banco_medicamentos`
--
ALTER TABLE `banco_medicamentos`
  ADD PRIMARY KEY (`id_banco_medicamento`);
...
--
-- Indices de la tabla `codigo_categoria_medicamento`
--
ALTER TABLE `codigo_categoria_medicamento`
...
ALTER TABLE `entrega_medicamentos`
  ADD PRIMARY KEY (`id_entrega_medicamento`);
...
--
-- Indices de la tabla `recepcion_medicamentos`
--
ALTER TABLE `recepcion_medicamentos`
  ADD PRIMARY KEY (`id_recepcion_medicamento`);
...
--
-- AUTO_INCREMENT de la tabla `banco_medicamentos`
--
ALTER TABLE `banco_medicamentos`
  MODIFY `id_banco_medicamento` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT de la tabla `codigo_categoria_medicamento`
--
ALTER TABLE `codigo_categoria_medicamento`
  MODIFY `id_codigo_categoria` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
...
--
ALTER TABLE `entrega_medicamentos`
  MODIFY `id_entrega_medicamento` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `presentacion_medicamentos`
  MODIFY `id_presentacion_medicamento` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT de la tabla `recepcion_medicamentos`
--
ALTER TABLE `recepcion_medicamentos`
  MODIFY `id_recepcion_medicamento` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `tbl_temporal_medicamentos`
  MODIFY `id_temporal_medicamento` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=137;
