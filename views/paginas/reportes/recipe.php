   ...
   <div class="container" style="margin-top: 20px;">
        <table style="border: 0px">
            <tr style="border: 0px">
                <th rowspan="2" style="border: 0px">
                    <img style="width: 100%; margin-top: 5px; float: left;" src="<?= SERVERURL ?>libs/img/cintillo1.png" alt="">
                </th>
            </tr>
            <tr style="border: 0px">
    ...
    <div class="container">
        <table>
            <thead>
                <tr style="border: 0px">
                    <th><p style="margin: 0px;">FECHA: <?php echo date("d/m/Y") ?></p></th>
                    <th><p style="margin: 0px;">HORA: <?php echo date("h:i a") ?></p></th>
                </tr>
